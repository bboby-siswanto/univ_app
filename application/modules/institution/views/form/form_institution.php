		...
		<div class="col-md-6">
			<div class="form-group">
				...
				<div class="input-group mb-3">
			        ...
			        <input class="form-control" type="text" id="country_name" placeholder="Country" required="true">
			        <input class="form-control" type="hidden" id="country_id" name="country_id">
			    </div>
			</div>
			<div class="form-group">
				...
				<div class="input-group mb-3">
			        ...
			        <input class="form-control" type="text" id="address_province" name="address_province" placeholder="Province" required="true">
			    </div>
			</div>
		</div>
		<div class="col-md-6">
			<div class="form-group">
				...
				<div class="input-group mb-3">
			        ...
			        <input class="form-control" type="text" id="address_city" name="address_city" placeholder="City" required="true">
			    </div>
			</div>
			<div class="form-group">
				...
				<div class="input-group mb-3">
			        ...
			        <input class="form-control" type="number" id="address_zipcode" name="address_zipcode" placeholder="Zip Code" required="true">
			    </div>
			</div>
		</div>
	</div>
